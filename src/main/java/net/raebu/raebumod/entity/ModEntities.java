...
public class ModEntities {
    ...
    public static final EntityType<MausholdThreeEntity> MAUSHOLD_3 = Registry.register(Registries.ENTITY_TYPE, Identifier.of(RaebuMod.MOD_ID, "maushold3"), EntityType.Builder.create(MausholdThreeEntity::new, SpawnGroup.CREATURE).dimensions(1, 2.5f).build());
    public static final EntityType<MausholdFourEntity> MAUSHOLD_4 = Registry.register(Registries.ENTITY_TYPE, Identifier.of(RaebuMod.MOD_ID, "maushold4"), EntityType.Builder.create(MausholdFourEntity::new, SpawnGroup.CREATURE).dimensions(1, 2.5f).build());
