...
public class ModEntities {
    ...
    public static final EntityType<SylveonEntity> SYLVEON = Registry.register(Registries.ENTITY_TYPE, Identifier.of(RaebuMod.MOD_ID, "sylveon"), EntityType.Builder.create(SylveonEntity::new, SpawnGroup.CREATURE).dimensions(1, 2.5f).build());
